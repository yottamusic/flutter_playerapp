...
import 'package:yottaplayer/util/artistInfo.dart';
import 'package:yottaplayer/util/utility.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:yottaplayer/database/database_client.dart';
import 'package:yottaplayer/pages/artistcard.dart';
import 'package:yottaplayer/pages/card_detail.dart';
import 'package:yottaplayer/pages/list_songs.dart';
import 'package:yottaplayer/pages/now_playing.dart';
import 'package:yottaplayer/util/lastplay.dart';
...
class HomeState extends State<Home> {
  ...
  aboutPart() {
    showAboutDialog(
      context: context,
      applicationName: "YottaPlayer",
      applicationVersion: "0.0.1",
      applicationLegalese: "",
      applicationIcon: ImageIcon(AssetImage("images/icon.png")),
      children: <Widget>[
        Center(
          child: Padding(
        ...
        Row(
          ...
          children: <Widget>[
            Container(
              child: IconButton(
                icon: ImageIcon(AssetImage("images/website.png")),
                onPressed: () {
                  launchUrl("https://YottaSens.com");
                },
                iconSize: 40.0,
              ),
            ),
