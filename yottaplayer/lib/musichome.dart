...
import 'package:yottaplayer/util/AAppBar.dart';
import 'package:yottaplayer/util/lastplay.dart';
import 'package:yottaplayer/views/album.dart';
import 'package:yottaplayer/views/artists.dart';
import 'package:yottaplayer/views/home.dart';
import 'package:yottaplayer/views/playlists.dart';
import 'package:yottaplayer/views/songs.dart';
      ...
      return showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                ...
                content: new Text('YottaPlayer will be Closed.'),
                actions: <Widget>[
                  new FlatButton(
